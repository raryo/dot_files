...
---- aaあしたは晴れですが、今日は曇りです。
---- aaあしたあしたasita明日はれると良いな
-- 明日ははれasi晨あした明日は晴れ明日は明日ははれ明後日
-- 
-- 明日ははれ明日あした明日明日は明日は明日は晴れあした
-- 今日は脱毛に行ってきたんだけど、担当の人からたくさん営業を受けてだるかった。
-- ついにダークパワーを手に入れたんだけど、送り仮名の概念が分かっていないな。
-- ついにダークパワーを明日の敵は今日の敵的な。
--
-- 明日の天気
-- ダークパワーasitaaがいねん概念だけど▽あした
-- ダークパワー明日
-- 明日の天気は晴れ、即ちくもり。
--
--
